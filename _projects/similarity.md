...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/tourism.webp" alt="Tourism destinations" title="Tourism destinations" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
<ul>
  <li><a href="/publications/">Publications</a> — filter by the <strong>E-Commerce</strong> topic to see this project's papers.</li>
